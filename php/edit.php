...
<body>
    ...
    <h1><a href="../index.html">Words to Works</a></h1>
        ...
        <input type="text" id="view_name" name="view_name" value="<?php if(!empty($message_data['view_name'])) {echo $message_data['view_name'];} ?> ">
    </div>
    <div>
    ...
    <input id="write" type="submit" name="btn_submit" value="更新">
